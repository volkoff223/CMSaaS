...
<div class="hero min-h-[60vh]">
  <div class="hero-content text-center py-12">
    <div class="max-w-xl">
      <div
        class="text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent mb-3 md:mb-7 pb-1"
      >
        Care Hub
      </div>
      ...
      <div class="mt-6 md:mt-10 text-sm md:text-lg">
        Built with child care facility owners, operaters, and directors in mind.
      </div>
